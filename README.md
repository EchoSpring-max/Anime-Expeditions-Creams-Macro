...
<p align="center">
  <a href="https://github.com/EchoSpring-max/Anime-Expeditions-Creams-Macro/releases/latest">
    <img src="https://img.shields.io/github/v/release/EchoSpring-max/Anime-Expeditions-Creams-Macro?style=flat-square&color=blue" alt="Latest Release">
  </a>
  <a href="https://github.com/EchoSpring-max/Anime-Expeditions-Creams-Macro/releases/latest">
    <img src="https://img.shields.io/github/downloads/EchoSpring-max/Anime-Expeditions-Creams-Macro/total?style=flat-square&color=green" alt="Downloads">
  </a>
  <a href="https://github.com/EchoSpring-max/Anime-Expeditions-Creams-Macro/actions/workflows/ci.yml">
    <img src="https://github.com/EchoSpring-max/Anime-Expeditions-Creams-Macro/actions/workflows/ci.yml/badge.svg" alt="CI">
  </a>
  <a href="LICENSE">
...
<p align="center">
  <a href="https://discord.gg/FwU6ppjKNf">Discord</a> · <a href="https://www.youtube.com/@Cweamya">YouTube</a> · <a href="https://github.com/EchoSpring-max/Anime-Expeditions-Creams-Macro/releases/latest">Download</a>
</p>
...
1. Open the [**Releases page**](https://github.com/EchoSpring-max/Anime-Expeditions-Creams-Macro/releases/latest)
...
```bash
git clone https://github.com/EchoSpring-max/Anime-Expeditions-Creams-Macro.git
...
Run `python tools/map_camera.py` for a small always-on-top capture tool. Enter
the map name and category, position the in-game camera, then press **F8**. It
saves a timestamped 1152×756 screenshot under `MapCaptures/`; **Install in
Macro** also copies the current capture into `Assets/map/<Category>/` for the
